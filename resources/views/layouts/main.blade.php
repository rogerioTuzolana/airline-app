                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-3 ">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo"> <a href="#"><img src="images/logo2.png"
                                            alt="PDC AIRLINE"><strong class="white">PDC AIRLINE</strong></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-9 col-lg-9 col-md-6 col-sm-9" id="logo_section">
                        <div class="menu-area">
                            <div class="limit-box">
                                <nav class="main-menu">
